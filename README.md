👋 Hi, I'm Yasmin Junior QA Analyst | Manual Testing | API Testing | SQL | Python
...
🧪 Manual Testing – Web Application Functional test cases, exploratory testing, regression cycles, and issue reporting.

🔗 API Testing with Postman API collections, request validation, assertions, environment variables, and documentation.
